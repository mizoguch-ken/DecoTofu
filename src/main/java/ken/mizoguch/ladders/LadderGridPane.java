...
public class LadderGridPane extends AnchorPane {
        ...
        switch (ladderGrid_.getBlock()) {
            ...
            case LOAD_FALLING:
                if (ladderGrid_.isBlockLd()) {
                    ...
                    ((Shape) grpBlock_.getChildren().get(0)).setFill(null);
            ...
            case OUT_FALLING_NOT:
                if (ladderGrid_.isBlockLd()) {
                    ((Shape) grpBlock_.getChildren().get(0)).setFill(onColor_);
                    ((Shape) grpBlock_.getChildren().get(0)).setStroke(onColor_);
                    ((Shape) grpBlock_.getChildren().get(5)).setFill(onColor_);
                    ((Shape) grpBlock_.getChildren().get(6)).setFill(onColor_);
                } else {
                    ((Shape) grpBlock_.getChildren().get(0)).setFill(null);
                    ((Shape) grpBlock_.getChildren().get(0)).setStroke(null);
                    ((Shape) grpBlock_.getChildren().get(5)).setFill(null);
                    ((Shape) grpBlock_.getChildren().get(6)).setFill(null);
                }
                ((Labeled) grpBlock_.getChildren().get(2)).setText(Double.toString(ladderGrid_.getBlockValue()));
                break;
            case COMPARISON_EQUAL:
    ...
    private void changeBlockWidth(double width) {
        ...
        switch (ladderGrid_.getBlock()) {
            case CONTENTS:
                ((Region) grpBlock_.getChildren().get(0)).setPrefWidth(width);
                break;
            case BLOCK_COMMENT:
                grpBlock_.getChildren().get(0).setLayoutX(baseStrokeWidth_);
                ((Region) grpBlock_.getChildren().get(0)).setPrefWidth(width - (baseStrokeWidth_ * 2.0));
                break;
            case CONNECT_LINE:
                ((Line) grpBlock_.getChildren().get(0)).setEndX(width);
                break;
            case LOAD:
                grpBlock_.getChildren().get(0).setLayoutX(width6);
                ((Rectangle) grpBlock_.getChildren().get(0)).setWidth(width - width3);
                grpBlock_.getChildren().get(1).setLayoutX(baseStrokeWidth_);
                ((Region) grpBlock_.getChildren().get(1)).setPrefWidth(width - width3);
                grpBlock_.getChildren().get(2).setLayoutX(width - width3);
                ((Region) grpBlock_.getChildren().get(2)).setPrefWidth(width3 - baseStrokeWidth_);
                grpBlock_.getChildren().get(3).setLayoutX(baseStrokeWidth_);
                ((Region) grpBlock_.getChildren().get(3)).setPrefWidth(width - (baseStrokeWidth_ * 2.0));
            ...
            case LOAD_FALLING_NOT:
                ...
                break;
            case OUT:
                grpBlock_.getChildren().get(0).setLayoutX(width3);
            ...
            case COMPARISON_XOR_BITS:
                ...
                grpBlock_.getChildren().get(3).setLayoutX(baseStrokeWidth_);
                ((Region) grpBlock_.getChildren().get(3)).setPrefWidth(width - (baseStrokeWidth_ * 2.0));
                grpBlock_.getChildren().get(4).setLayoutX(width6 + baseStrokeWidth_);
                ((Region) grpBlock_.getChildren().get(4)).setPrefWidth(width - width3 - (baseStrokeWidth_ * 2.0));
                ((Line) grpBlock_.getChildren().get(5)).setEndX(width6);
            ...
            case RANDOM:
                ...
                grpBlock_.getChildren().get(7).setLayoutX(width6 + baseStrokeWidth_);
                ((Region) grpBlock_.getChildren().get(7)).setPrefWidth(width - width3 - (baseStrokeWidth_ * 2.0));
                break;
            case AND_BITS:
            case OR_BITS:
            case XOR_BITS:
            ...
            case SIGMOID:
                ...
                grpBlock_.getChildren().get(4).setLayoutX(width6 + baseStrokeWidth_);
                ((Region) grpBlock_.getChildren().get(4)).setPrefWidth(width - width3 - (baseStrokeWidth_ * 2.0));
                grpBlock_.getChildren().get(5).setLayoutX(width6 + baseStrokeWidth_);
                ((Region) grpBlock_.getChildren().get(5)).setPrefWidth(width - width3 - (baseStrokeWidth_ * 2.0));
                ((Line) grpBlock_.getChildren().get(6)).setEndX(width6);
            ...
            case SCRIPT:
                ...
                grpBlock_.getChildren().get(8).setLayoutX(width6 + baseStrokeWidth_);
                ((Region) grpBlock_.getChildren().get(8)).setPrefWidth(width - width3 - (baseStrokeWidth_ * 2.0));
                break;
            case TIMER_NOT:
            case COUNTER_NOT:
                grpBlock_.getChildren().get(0).setLayoutX(width6);
    ...
    private void changeBlockHeight(double height) {
        ...
        switch (ladderGrid_.getBlock()) {
            case CONTENTS:
                ((Region) grpBlock_.getChildren().get(0)).setPrefHeight(height);
                break;
            case BLOCK_COMMENT:
                ((Labeled) grpBlock_.getChildren().get(0)).setFont(Font.font(height6));
                grpBlock_.getChildren().get(0).setLayoutY(baseStrokeWidth_);
                ((Region) grpBlock_.getChildren().get(0)).setPrefHeight(height - (baseStrokeWidth_ * 2.0));
                break;
            case CONNECT_LINE:
                ...
                break;
            case LOAD:
                grpBlock_.getChildren().get(0).setLayoutY(height4);
                ((Rectangle) grpBlock_.getChildren().get(0)).setHeight(height - height2);
                ((Labeled) grpBlock_.getChildren().get(1)).setFont(Font.font(height6));
                ((Region) grpBlock_.getChildren().get(1)).setPrefHeight(height6);
                ((Labeled) grpBlock_.getChildren().get(2)).setFont(Font.font(height6));
                ((Region) grpBlock_.getChildren().get(2)).setPrefHeight(height6);
                ((Labeled) grpBlock_.getChildren().get(3)).setFont(Font.font(height6));
                grpBlock_.getChildren().get(3).setLayoutY(height - height4);
                ((Region) grpBlock_.getChildren().get(3)).setPrefHeight(height6);
            ...
            case COMPARISON_XOR_BITS:
                ...
                grpBlock_.getChildren().get(3).setLayoutY(height - height4);
                ((Region) grpBlock_.getChildren().get(3)).setPrefHeight(height6);
                ((Labeled) grpBlock_.getChildren().get(4)).setFont(Font.font(height6));
                grpBlock_.getChildren().get(4).setLayoutY(height2 - height12);
                ((Region) grpBlock_.getChildren().get(4)).setPrefHeight(height6);
                ...
                ((Labeled) grpBlock_.getChildren().get(9)).setFont(Font.font(height6));
            ...
            case RANDOM:
                ...
                ((Line) grpBlock_.getChildren().get(6)).setStartY(height4);
                ((Line) grpBlock_.getChildren().get(6)).setEndY(height - height4);
                ((Labeled) grpBlock_.getChildren().get(7)).setFont(Font.font(height6));
                grpBlock_.getChildren().get(7).setLayoutY(height5);
                ((Region) grpBlock_.getChildren().get(7)).setPrefHeight(height6);
                break;
            case AND_BITS:
            case OR_BITS:
            case XOR_BITS:
            ...
            case SIGMOID:
                ...
                grpBlock_.getChildren().get(4).setLayoutY(height2 - height12);
                ((Region) grpBlock_.getChildren().get(4)).setPrefHeight(height6);
                ((Labeled) grpBlock_.getChildren().get(5)).setFont(Font.font(height6));
                grpBlock_.getChildren().get(5).setLayoutY(height2 + height12);
                ((Region) grpBlock_.getChildren().get(5)).setPrefHeight(height6);
            ...
            case SCRIPT:
                ...
                ((Line) grpBlock_.getChildren().get(7)).setStartY(height4);
                ((Line) grpBlock_.getChildren().get(7)).setEndY(height - height4);
                ((Labeled) grpBlock_.getChildren().get(8)).setFont(Font.font(height6));
                grpBlock_.getChildren().get(8).setLayoutY(height5);
                ((Region) grpBlock_.getChildren().get(8)).setPrefHeight(height6);
                break;
            case TIMER_NOT:
            case COUNTER_NOT:
                grpBlock_.getChildren().get(0).setLayoutY(height4);
        ...
        switch (ladderGrid_.getBlock()) {
            case CONTENTS:
                ...
                if ((ladderGrid_.getColumnIndex() == 0) && (ladderGrid_.getRowIndex() == 0)) {
                    ...
                    ((Labeled) grpBlock_.getChildren().get(0)).setText(Integer.toString(ladderGrid_.getRowIndex()));
    ...
    public void changeComment() {
        switch (ladderGrid_.getBlock()) {
            case BLOCK_COMMENT:
                ((Labeled) grpBlock_.getChildren().get(0)).setText(ladderGrid_.getComment());
                break;
            case LOAD:
            case LOAD_NOT:
            case LOAD_RISING:
        ...
        switch (ladderGrid_.getBlock()) {
            ...
            case SIGMOID:
                ...
                if (ladderGrid_.getBlockFunctions()[1].isNumber()) {
                    ...
                    ((Labeled) grpBlock_.getChildren().get(5)).setText(ladderGrid_.getBlockFunctions()[1].getAddress());
                }
                break;
            case TIMER:
            case COUNTER:
                if (ladderGrid_.getBlockFunctions()[0].isNumber()) {
                    if (!ladderGrid_.isBlockLd()) {
                        ...
                        ((Labeled) grpBlock_.getChildren().get(4)).setText("0");
                    }
                } else {
                    ((Labeled) grpBlock_.getChildren().get(4)).setText(ladderGrid_.getBlockFunctions()[0].getAddress());
                }
